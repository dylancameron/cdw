...
})(
	{
			...
			function (t, e, i) {
				...
				e.exports = function (t, e, i, p, d, m) {
					...
					if (
						...
						(g = p.getConstructor(e, t, d, v)), o(g.prototype, i);
					return (
						f(g, t),
						(x[t] = g),
						n(n.G + n.W + n.F * (g != _), x),
		...
		73: [
			function (t, e, i) {
				...
				e.exports = function (t, e, i, o) {
					...
					return (
						f.length > h && (f = f.slice(0, h)), o ? f + a : a + f
					);
				};
			},
					...
					I = function () {
						...
						for (
							e.style.display = "none",
								...
								t.open(),
								t.write(
									"<script>document.F=Object</script" + r
								),
								t.close(),
								I = t.F;
							i--;
		...
		111: [
			function (t, e, i) {
				var r = t("./$.export"),
					...
					o = Math.acosh;
				r(
					r.S + r.F * !(o && 710 == Math.floor(o(Number.MAX_VALUE))),
					"Math",
					{
						acosh: function (t) {
							return (t = +t) < 1
					...
					_ = function (t) {
						...
						if ("string" == typeof e && e.length > 2) {
							...
							if (43 === s || 45 === s) {
								...
								for (
									var o, l = e.slice(2), c = 0, h = l.length;
									c < h;
									c++
								)
									if (
										((o = l.charCodeAt(c)), o < 48 || o > n)
									)
										return NaN;
								return parseInt(l, r);
							}
			...
			function (t, e, i) {
				...
				var r,
					...
					S = (function () {
						...
						try {
							if (
								...
								e.resolve(5).then(function () {}) instanceof
									e || (i = !1),
								i && t("./$.descriptors"))
							) {
								var r = !1;
					...
					k = function (t) {
						var e;
						return (
							!(!c(t) || "function" != typeof (e = t.then)) && e
						);
					},
					R = function (t) {
						var e, i;
					...
					"Reflect",
					{
						construct: function (t, e) {
							...
							if (t == i) {
								...
								var n = [null];
								return (
									n.push.apply(n, e), new (l.apply(t, n))()
								);
							}
							var u = i.prototype,
				...
				r(r.P + r.F * t("./$.fails-is-regexp")(o), "String", {
					startsWith: function (t) {
						var e = s(this, t, o),
							i = arguments,
							r = n(
								Math.min(i.length > 1 ? i[1] : void 0, e.length)
							),
							l = String(t);
						return a
							? a.call(e, l, r)
							: e.slice(r, r + l.length) === l;
					},
				});
			},
			{
			...
			function (t, e, i) {
				...
				var r = t("./$"),
					...
					z = function (t, e) {
						v(t);
						for (
							var i, r = _((e = y(e))), n = 0, s = r.length;
							s > n;
				...
				(function (t) {
					...
					(i._gsQueue || (i._gsQueue = [])).push(function () {
								...
								function (t, e, r) {
									...
									return (
										...
										(g.call = function (t, e, i, n) {
											return this.add(
												r.delayedCall(0, t, e, i),
												n
											);
										}),
										(g.set = function (t, e, i) {
											return (
												(i = this._parseTimeOrLabel(
													i,
													0,
													!0
												)),
										...
										(g.invalidate = function () {
											...
											return t.prototype.invalidate.call(
												this
											);
										}),
										(g._enabled = function (t, i) {
											if (t === this._gc)
												for (var r = this._first; r; )
													r._enabled(t, !0),
														(r = r._next);
											return e.prototype._enabled.call(
												this,
												t,
												i
											);
											...
											if (!e)
												for (
													...
													i._startTime === r &&
														...
														(i._rawPrevTime = 0),
														(i = i._next);
											return t.prototype.paused.apply(
												this,
												arguments
											);
										}),
										...
										(h.totalDuration = function (e) {
											return arguments.length
												? this._repeat !== -1 && e
													...
													: this
												: (this._dirty &&
														(t.prototype.totalDuration.call(
															this
														),
														(this._totalDuration =
															this._repeat === -1
							...
							i._gsDefine(
								...
								function (t, e) {
									...
									var Tt = function (t, e) {
										...
										Pt = (G._registerComplexSpecialProp =
											function (t, e, i) {
												"object" != typeof e &&
													(e = {
														parser: i,
										...
										St = (G._registerPluginProp = function (
											t
										) {
											if (!u[t]) {
												var e =
									...
									(c = Tt.prototype),
										...
										(a.registerSpecialProp = function (
											t,
											e,
											i
										) {
						...
						(function (t, i) {
							...
							var r = {},
								n = t.document,
								s = (t.GreenSockGlobals =
									t.GreenSockGlobals || t);
							if (!s.TweenLite) {
								var o,
									a,
									l,
								...
								x("Ticker", function (t, e) {
									...
									(l = f.Ticker.prototype =
										new f.events.EventDispatcher()),
												...
												t._paused &&
													...
													(t._pauseTime =
														...
														(this.rawTime() -
															...
															t._timeScale),
												t.timeline &&
													t.timeline._remove(t, !0),
												(t.timeline = t._timeline =
													this),
				...
				(n.prototype = {
					...
					createUniform: function (t, e) {
						for (
							...
							r[n - 2] = arguments[n];
						o.createUniform.apply(
							o,
							[this.gl, this.program, t, e].concat(r)
						);
					},
		...
		207: [
			function (t, e, i) {
				...
				function a() {
					// Call the showVignette function to set the default state on page load
					showVignette("vignette-1");
					...
					document.addEventListener("mousemove", function (t) {
						...
						w["default"].to(V, 1, {
							...
							onUpdate: function onUpdate() {
								// Apply the increased parallax values
								(q.parallaxX = V.x * intensityMultiplier),
									(q.parallaxY = V.y * intensityMultiplier);
							},
						});
					});
				}
				...
				function l() {
					setInterval(function () {
						(0, S.chance)(K.flashChance) &&
							f(K.bg, K.fg, K.flashBg, K.flashFg);
					}, 500);
				}
				function u() {
					c(),
				...
				function h() {
					...
					null != n && n.classList.remove("--current");
					// var s = document.querySelector(".weather-item--current");
					// null != s && s.classList.remove("weather-item--current"),
					e.classList.add("--current");
					// i.classList.add("weather-item--current");
				}
				...
				var d = t("./rain-renderer"),
					...
					X = void 0,
					// BACKGROUNDSize
					U = { width: 2000, height: 1500 },
					Y = { width: 1000, height: 750 },
					G = void 0,
					q = void 0,
					W = void 0,
					V = { x: 0, y: 0 },
				...
				(s.prototype = Object.defineProperties(
					{
						...
						renderDropsGfx: function () {
							...
							(this.dropsGfx = Array.apply(null, Array(255)).map(
								...
								(this.clearDropletsGfx = (0, c["default"])(
									128,
									128
								));
						...
						addDrop: function (t) {
							return (
								!(
									this.drops.length >=
										this.options.maxDrops *
											this.areaMultiplier || null == t
								) && (this.drops.push(t), !0)
							);
						},
		...
		212: [
			function (t, e, i) {
				...
				function n(t, e, i) {
					// Assuming 't' is WebGLRenderingContext

					// Check the maximum supported vertex attributes
					var maxVertexAttribs = t.getParameter(t.MAX_VERTEX_ATTRIBS);

					// Ensure that the indices are within the valid range
					var c = Math.min(0, maxVertexAttribs - 1);
					var u = Math.min(1, maxVertexAttribs - 1);

					// Enable and attribute vertex attributes
					t.enableVertexAttribArray(c);
					t.vertexAttribPointer(c, 2, t.FLOAT, false, 0, 0);

					var p = t.createBuffer();

					t.bindBuffer(t.ARRAY_BUFFER, p);
					t.enableVertexAttribArray(u);
					t.vertexAttribPointer(u, 2, t.FLOAT, false, 0, 0);
